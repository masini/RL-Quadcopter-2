...
class Actor:
    ...
    def build_model(self):
        ...
        # Add hidden layers
        net = create_dense_layer(states, 300)
        net = create_dense_layer(net, 400)
...
def create_dense_layer(previous_layer, units):
    layer = layers.Dense(units=units,kernel_regularizer=layers.regularizers.l2(1e-6))(previous_layer)
    layer = layers.BatchNormalization()(layer)
    layer = layers.LeakyReLU(1e-2)(layer)
